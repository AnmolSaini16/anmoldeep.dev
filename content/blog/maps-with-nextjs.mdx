...
export default function MapCotrols() {
  ...
  return (
    <aside className="bg-background absolute bottom-8 right-4 z-10 flex flex-col gap-2 rounded-lg p-2 shadow-lg">
...
export default function MapSearch() {
  ...
  return (
    <>
      <section className="absolute left-1/2 top-4 z-10 w-[90vw] -translate-x-1/2 rounded-lg shadow-lg sm:left-4 sm:w-[350px] sm:translate-x-0">
...
![Next Map Demo](https://dev-to-uploads.s3.amazonaws.com/uploads/articles/jubyxfk0yik4r28u2x66.png)
